...
| Item | Blocked on |
|------|-----------|
| Run SQL 52 (reassigning a returned job hands it over fresh; submitted jobs can't be reassigned) | Mihir → SQL Editor |
| Assigning TOMORROW's work in advance (PPM jobs are created on their due date; honest-dates deliberately refuses future starts — needs a "scheduled, not started" concept) | Design decision with Mihir |
